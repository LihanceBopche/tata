    ...
    return (
        <div className="flex h-screen w-full items-center justify-center bg-gray-50">
            <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-xl border border-gray-100">
                ...
                <p className="text-sm font-medium text-center text-gray-500 mb-6 tracking-wide">EMPLOYEE REGISTRATION</p>
                ...
                <p className="mt-4 text-center text-sm text-gray-600">
                    Already have an account? <Link href="/login" className="text-tata-accent font-semibold hover:underline">Login</Link>
                </p>
            </div>
        </div>
    );
